...
const Task = ({ setDisplayy,
  ...
  // console.log("Here is User Data", URL)
  ...
  const showUpdateBox = () => {
    // setUpdateTaskId(Data)
    // let d = "flex";
    // setDisplayy(d);
    // d = "block";
    // setUDisplayy(d);
    // console.log("The Data in Update form is:",Data)
    history.push({
      pathname: '/update',
      state: {Data }
    });
    ...
    <>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary" data-dismiss="modal" onClick={() => handleDelete(Data.id)}>Yes</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="task-container col-12 col-md-6 my-2 py-0 px-3">
        <div className="task-data p-3 ">
          ...
          <img src={Taskmg} className="w-100" />
        </div> */}
